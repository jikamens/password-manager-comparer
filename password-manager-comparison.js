...
var passwordManagerTable = function() {
  var rawData = [
    ...
    ["Mac OS, Windows support",                                          ["OR", "MacOS", "Windows"],          ["yes",       "yes",      "yes",       "yes",      "yes",     "yes",        "yes"],      null],
    ["Linux support",                                                    ["Linux"],                           ["poor",      "poor",     "yes",       "yes",      "yes",     "yes",        "poor"],     null],
    ["Mac OS command-line client",                                       ["MacOS", "CLI"],                    ["yes",       "no",       "yes",       "poor",     "yes",     "no",         "no"],       null],
    ...
    ["YubiKey support in iOS (Lightning)",                               ["iOS", "YubiKey"],                  ["yes",       "no",       "no",        "yes",      "no",      "no",         "no"],       null],
    ...
    ["Create new items in web app",                                      [],                                  ["yes",       "unknown",  "yes",       "yes",      "unknown", "unknown",    "no"],       null],
    ...
    ["Password history on Windows, Mac OS",                              ["OR", "Windows", "MacOS"],          ["yes",       "yes",      "yes",       "yes",      "yes",     "yes",        "no"],       null],
    ["Secure notes",                                                     [],                                  ["yes",       "yes",      "yes",       "yes",      "yes",     "poor",       "yes"],      null],
    ["Attachments on notes on Linux",                                    ["Linux"],                           ["no",        "no",       "yes",       "yes",      "yes",     "yes",        "no"],       null],
    ["Attachments on notes on Windows, Mac OS",                          ["OR", "Windows", "MacOS"],          ["yes",       "yes",      "yes",       "yes",      "yes",     "yes",        "no"],       null],
    ...
    ["Shared folders with access control on Mac OS",                     ["MacOS", "Enterprise"],             ["yes",       "yes",      "yes",       "yes",      "yes",     "yes",        "yes"],      null],
    ...
    ["Browser plugin prompts to save new sites on Windows, Mac OS",      ["OR", "Windows", "MacOS"],          ["yes",       "yes",      "yes",       "yes",      "yes",     "yes",        "yes"],      null],
    ["2FA integrated into login entries in vault",                       [],                                  ["yes",       "no",       "yes",       "no",       "no",      "no",         "no"],       null],
    ["Auto-fill in browser disabled by default",                         [],                                  ["yes",       "no",       "yes",       "no",       "no",      "yes",        "yes"],      null],
    ...
    ["Exporting items on Windows, Mac OS",                               ["OR", "Windows", "MacOS"],          ["yes",       "yes",      "yes",       "yes",      "yes",     "yes",        "yes"],      null],
